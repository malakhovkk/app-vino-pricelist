...
import { createContact, getContacts, getVendors } from "../../restApi/index";
...
export default function ContactPopUp() {
  ...
  useEffect(() => {
    setContact1(contactInfo);
  }, [contactInfo]);
  const [contact1, setContact1] = useState(contactInfo);
  return (
    <Popup
      onHiding={() => {
        ...
        <div className="dx-field">
          ...
          <div className="dx-field-value">
            <TextBox
              ...
              onValueChanged={(e) => {
                console.log(e);
                setContactInfo({ ...contactInfo, name: e.value });
